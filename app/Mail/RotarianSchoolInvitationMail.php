...
class RotarianSchoolInvitationMail extends Mailable
{
    ...
    public function __construct($school_name, $rotarian, $invite_token, $year)
    {
    ...
    {
        $autoreply = AutoreplyEmail::find(7);
        ...
        $subject = "Invitation by ".$this->rotarian->contact_salutation." ".$this->rotarian->firstname.' '.$this->rotarian->lastname.' for '.$this->school_name.' to register for Brush-a-mania '.$this->year;
