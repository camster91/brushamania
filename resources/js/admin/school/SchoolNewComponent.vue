        				...
        				<div class="card">
        						...
        						<div class="row">
        							...
        							<div class="col-md-6">
        								<div class="form-group">
											...
											<select name="year" class="form-control" v-model="school.selected_year">
        					...
        					<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="label">Name of Dentist Requested (optional)</label>
											<input type="text" class="form-control" name="dentist" v-model="school.requested_dentist">
										</div>
									</div>
								</div>	
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="label">Number of Classes (required)</label>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="label">Number of Students  (required)</label>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<input type="datetime-local" class="form-control" name="presentation_date" v-model="school.presentation_date">
									</div>
								</div>	
								<div class="row">
									<div class="col-md-12">
		...
		methods: {
			...
			setYear() {
				axios.get('/year/active').then((response) => {
					this.school.selected_year = response.data.year;
				}).catch((error) => {
					console.log(error);
				})
			},
