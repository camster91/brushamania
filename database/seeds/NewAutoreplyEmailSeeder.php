...
class NewAutoreplyEmailSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
		...
		$email1->name = "Rotarian School Invitation";
		$email1->url_slug = "rotarian-school-invitation";
		$email1->content = '<p>Hello [school_name], [rotarian_name] has requested that your school be part of the Brush-a-mania program this year. <a href="http://app.brushamania.ca/school-registration?invite_token=[invite_token]">Please register here</a>.</p>
		...
		$email2->name = "Rotarian Dentist Invitation";
		$email2->url_slug = "rotarian-dentist-invitation";
		$email2->content = '<p>Hello Dr. [dentist_name], [rotarian_name] has requested that you will be part of the Brush-a-mania program this year. <a href="http://app.brushamania.ca/dentist-registration?invite_token=[invite_token]">Please register here</a>.</p>
